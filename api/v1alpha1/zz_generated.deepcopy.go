...
func (in *AppBundleBaseSpec) DeepCopyInto(out *AppBundleBaseSpec) {
	*out = *in
	...
	if in.Routes != nil {
		...
		*out = make(map[string]AppBundleRoute, len(*in))
		for key, val := range *in {
	...
	if in.Volumes != nil {
		...
		*out = make(map[string]AppBundleVolume, len(*in))
		for key, val := range *in {
			(*out)[key] = *val.DeepCopy()
		}
	}
	...
	if in.Configs != nil {
		...
		*out = make(AppBundleConfigs, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(AppBundleConfig)
				(*in).DeepCopyInto(*out)
			}
		}
	}
...
func (in *AppBundleConfig) DeepCopyInto(out *AppBundleConfig) {
	*out = *in
	if in.Existing != nil {
		...
		*out = new(AppBundleExistingConfig)
		**out = **in
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in AppBundleConfigs) DeepCopyInto(out *AppBundleConfigs) {
	{
		in := &in
		*out = make(AppBundleConfigs, len(*in))
		for i := range *in {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AppBundleConfigs.
func (in AppBundleConfigs) DeepCopy() AppBundleConfigs {
	if in == nil {
		return nil
	}
	out := new(AppBundleConfigs)
	in.DeepCopyInto(out)
	return *out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AppBundleExistingConfig) DeepCopyInto(out *AppBundleExistingConfig) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AppBundleExistingConfig.
func (in *AppBundleExistingConfig) DeepCopy() *AppBundleExistingConfig {
	if in == nil {
		return nil
	}
	out := new(AppBundleExistingConfig)
...
func (in *AppBundleSpec) DeepCopyInto(out *AppBundleSpec) {
	*out = *in
	...
	if in.TailscaleName != nil {
		in, out := &in.TailscaleName, &out.TailscaleName
		*out = new(string)
		**out = **in
	}
	if in.Command != nil {
